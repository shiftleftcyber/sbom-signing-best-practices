...
Thank you for your interest in contributing! This project aims to demonstrate interoperable SBOM hashing across multiple languages.
...
### 3. Reporting Issues
* Please specify which language implementation you are using (or if it is a flaw in the core spec).
